...
<head>
    ...
    <style>
        body.admin-login-page {
            ...
            background: url("../Images/maintainance_image.jpeg") no-repeat center center
                fixed;
    ...
    <div class="background-wrapper">
        <div class="container pt-5" id="login">
            <div class="text-center mb-4">
                ...
                <p class="text-center" style="font-size:30px; color: #f8f9fa; font-family: 'Ubuntu', sans-serif;"><i class="fas fa-user-secret text-white" style="font-size:30px;"></i> Admin Login Area
                </p>
            </div>
