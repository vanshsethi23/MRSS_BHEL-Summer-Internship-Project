...
if(isset($_REQUEST['view'])) {
    $sql = "SELECT * FROM submitmaintenancerequest_tb WHERE request_id = {$_REQUEST['id']}";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
}
if(isset($_REQUEST['close'])) {
    $sql = "DELETE FROM submitmaintenancerequest_tb WHERE request_id = {$_REQUEST['id']}";
...
<!-- Starting Assigned Work 3rd Column -->
...
<!-- Ending Assigned Work 3rd Column -->
